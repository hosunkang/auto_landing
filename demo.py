...
parser.add_argument("--image_folder", type=str, default="data/sample", help="path to image folder")
parser.add_argument("--save_folder", type=str, default='result', help='path to saving result folder')
